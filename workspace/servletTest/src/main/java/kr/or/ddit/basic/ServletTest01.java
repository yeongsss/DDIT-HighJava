...
/*
	http://localhost:8088/servletTest/servletTest01.do
	- http ==> 프로토콜
	- localhost ==> 컴퓨터이름(도메인명) 또는 IP주소
	- 80 ==> Port번호 (80번일  경우에는 생략가능)
...
public class ServletTest01 extends HttpServlet{
	...
	// 이 떄 다음과 같은 객체가 자동으로 생성되어서 위 메소드의 파라미터로 넘겨진다.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/html; charset=UTF-8");	// 응답문서의 ContentType
