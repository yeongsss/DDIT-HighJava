...
public class TcpMultiChatServer {
	...
	public void serverStart() {
		...
		try {
			...
			while(true) {
				...
				// 메시지를 받아서 전체에게 전송하는 Thread 실행하기
	...
	// clientMap에 저장된 전체 접속자에게 메시지를 전송하는 메소드
	private void sendToAll(String mag) {
	...
	// Inner Class형태로 서버에서 클라이언트로 메시지를 전송하는 Thread를 만든다.
